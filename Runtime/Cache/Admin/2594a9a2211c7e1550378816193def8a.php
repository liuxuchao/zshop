                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                              <?php if(!empty($ruleList) and is_array($ruleList)): if(is_array($ruleList)): $i = 0; $__LIST__ = $ruleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ruleList): $mod = ($i % 2 );++$i;?><tr>
                                  <td><?php echo ($ruleList["id"]); ?></td>
                                  <td class="hidden-phone"><?php echo ($ruleList["title"]); ?></td>
                                  <td class="hidden-phone"><?php echo ($ruleList["name"]); ?></td>
                                  <td>
                                  <a class="btn btn-primary btn-xs" href="/Admin/Auth/ruleUpdates/id/<?php echo ($ruleList["id"]); ?>">修改</a>&nbsp;|&nbsp;
