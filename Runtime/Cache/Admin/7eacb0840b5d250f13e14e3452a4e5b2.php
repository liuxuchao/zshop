...
<html lang="en">
  <head>
    ...
    <title>Zshop商城-管理-文章列表-第<?php echo ($currentPage); ?>页</title>
    <!-- Bootstrap core CSS -->
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              文章分类列表
                              <a href="/Admin/Article/add"><button type="button" class="btn btn-success pull-right btn-sm">添加文章</button></a>                      
                          </header>
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                              <?php if(!empty($articleList) and is_array($articleList)): if(is_array($articleList)): $i = 0; $__LIST__ = $articleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$articleList): $mod = ($i % 2 );++$i;?><tr>
                                  <td class="hidden-phone"><?php echo ($articleList["id"]); ?></td>
                                  <td><?php echo ($articleList["title"]); ?></td>
                                  <td><?php echo ($articleList["cate_name"]); ?></td>
                                  
                                  <td><?php echo (date("Y-m-d H:i:s",$articleList["create_time"])); ?></td>
                                  <td>
                                  <a class="btn btn-primary btn-xs" href="/Admin/Article/updates/id/<?php echo ($articleList["id"]); ?>">修改文章</a>
                                  <a  class="btn btn-xs btn-warning myModal2" data-toggle="modal" href="#myModal2" value="<?php echo ($articleList["id"]); ?>">删除</a>
                                  </td>
            ...
            $("#confirmvalue").click(function(){
              ...
              $("body").removeClass("modal-open");
                var articleId = $(this).attr("value");
                  $.post("/Admin/Article/doDelete",{id:articleId},function(data,textStatus, jqXHR){
